...
.community-background {
    ...
    background-color: #B4E8CE; /* Warna fallback jika gambar tidak dimuat */
    padding: 2%;
    margin-top: 2%;
    margin-bottom: 2%;
	...
	<div class="row">
		...
		<div class="col-md-4 col-lg-3 pt-3">
			<div class="sidebar bg-white border-custom">
				<a href="{{ route('viewcommunity') }}" class="btn btn-primary w-100 no-padding" style="background-color: #015AAA;">+ Create New Community</a>
