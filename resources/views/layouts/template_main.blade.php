...
<html lang="en">
	...
	<div id="splash-screen" class="splash-screen">
		<img src="/assets/img/Thrivian.org.png" alt="Thrivian-logo" class="logo">
	</div>
	<body>
		@if ($errors->any())
		<script>
		...
		<nav class="navbar navbar-light bg-light fixed-top d-none d-lg-block">
			<div class="container">
				...
				<img src="/assets/img/Thrivian.org.png" alt="Thrivian.org" width="180" height="35">
				</a>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top d-lg-none">
			<div class="container-fluid">
				...
				<img src="/assets/img/Thrivian.org.png" alt="Thrivian.org" width="150">
				</a>
